...
if (isset($_GET['del']) and $_GET['del'] == 1) {
    $inf = "DELETE FROM info_alimento WHERE id_info_alimento = {$id}";
                ...
                <div class='row justify-content-center'>
                    <div class='col-6'>
                        <div class='col-12'>
                            ...
                            <div class='form-floating'>
                                <input type='text' class='form-control' name='embalagem' value='<?php echo $result["embalagem"]; ?>' disabled>
                                <label for='exampleFormControlInput1' class='form-label'><strong>Cor</strong></label>
                            </div>
                            <div class="form-floating">
                                <input type="text" class="form-control" name="peso" value="<?php echo $result['peso']; ?>" disabled>
                            ...
                            <div class='form-floating' style='margin-bottom: 5mm;'>
                                <input type='text' class='form-control' name='sabor' value='<?php echo $result["sabor"]; ?>' disabled>
